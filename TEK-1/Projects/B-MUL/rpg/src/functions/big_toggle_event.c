...
static void toggle_hover(gamedata_t *gamedata, big_toggle_t *toggle)
{
...
static void toggle_press(gamedata_t *gamedata, big_toggle_t *toggle)
{
    sfVector2f mousePos = get_pixcoord(gamedata);
...
static void draw_toggle_off(gamedata_t *gamedata, big_toggle_t *toggle)
{
    sfIntRect newPos;
...
static void draw_toggle(gamedata_t *gamedata, big_toggle_t *toggle)
{
    sfIntRect newPos;
