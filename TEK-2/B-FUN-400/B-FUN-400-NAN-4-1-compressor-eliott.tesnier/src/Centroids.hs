...
calculateDistances :: [Pixel] -> [Color] -> [Float]
...
selectPixel :: [Pixel] -> [Float] -> Float -> Pixel
...
initializeCentroids :: Int -> [Pixel] -> [Color]
