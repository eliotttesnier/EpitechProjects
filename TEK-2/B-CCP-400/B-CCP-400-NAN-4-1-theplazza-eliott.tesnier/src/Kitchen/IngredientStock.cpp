...
const std::vector<std::string> IngredientStock::ALL_INGREDIENTS = {
    Pizza::Ingredients::DOUGH,
    Pizza::Ingredients::TOMATO,
    Pizza::Ingredients::GRUYERE,
    Pizza::Ingredients::HAM,
    Pizza::Ingredients::MUSHROOMS,
    Pizza::Ingredients::STEAK,
    Pizza::Ingredients::EGGPLANT,
    Pizza::Ingredients::GOAT_CHEESE,
    Pizza::Ingredients::CHIEF_LOVE
};
